...
from users.views import ActivateAccount,Register
...
urlpatterns = [
    ...
    path('reset/',auth_views.PasswordResetView.as_view(template_name = 'users/password_reset.html') , name = 'password-reset'),
